...
exec "hi Normal         cterm=NONE   ctermfg=252" . " ctermbg=" . <SID>X(80)
...
"hi LineNr		ctermfg=250		ctermbg=232		cterm=none		guifg=#857b6f	guibg=#080808	gui=none
exec "hi LineNr ctermfg=" . <SID>X(80) . " ctermbg=252"
...
hi Comment		ctermfg=Cyan		cterm=none		guifg=#9c998e	gui=italic
